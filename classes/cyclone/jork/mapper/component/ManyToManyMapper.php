...
class ManyToManyMapper extends AbstractMapper {
    ...
    protected function comp2join() {
        ...
        $local_join_col_schema = $this->_parent_mapper->_entity_schema->primitives[$local_join_col];
        ...
        $remote_join_col_schema = $remote_schema->primitives[$remote_join_col];
        $remote_table = isset($remote_join_col_schema->table)
